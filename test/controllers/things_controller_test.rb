...
class ThingsControllerTest < ActionController::TestCase
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post :create, thing: { link: @thing.link, type: @thing.type, user_id: @thing.user_id, value: @thing.value }
    end
  ...
  test "should update thing" do
    patch :update, id: @thing, thing: { link: @thing.link, type: @thing.type, user_id: @thing.user_id, value: @thing.value }
    assert_redirected_to thing_path(assigns(:thing))
  end
